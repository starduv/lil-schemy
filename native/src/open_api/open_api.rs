...
use super::deferred_schemas::DeferredSchemas;
...
impl ApiPathOperation {
    ...
    pub fn tags(&mut self, tags: Option<Vec<String>>) -> &mut ApiPathOperation {
        self.tags = tags;
        self
    }

    pub fn response(&mut self, response_type: &Option<String>, response_args: ResponseOptions) -> &mut ApiResponse {
    ...
    pub fn param(&mut self, name: &str, location: &str) -> &mut ApiParam {
    ...
    pub fn body(&mut self) -> &mut ApiParam {
